...
const TopicForm = ({ setResult, setLoading, loading, setError }) => {
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl mx-2 bg-gradient-to-br from-black/90 via-black/80 to-black/90 backdrop-blur-2xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.75)] p-8 space-y-6 text-white"
    >
      <input
        type="text"
      ...
      <input
        ...
        value={classLevel}
        placeholder="Enter Your Level. (e.g. Class 1 - 12, Gradute, Post-Graduate) "
        className="w-full p-3 rounded-xl bg-white/10 backdrop-blur-lg border border-white/20 placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-white/30"
      />
      <input
        type="text"
        ...
        value={examType}
        placeholder="Exam Type (e.g. CBSE, JEE, NEET, SSC)"
        className="w-full p-3 rounded-xl bg-white/10 backdrop-blur-lg border border-white/20 placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-white/30"
      />
