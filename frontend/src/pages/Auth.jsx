  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-black px-8">
      <motion.header
        ...
        className="shadow-[0_5px_15px_rgba(0,0,0,0.75)]  mt-5 rounded-2xl bg-gradient-to-br from-black/90 via-black/80 to-black/90 backdrop-blur-xl border border-white/10 px-8 py-6 "
      >
